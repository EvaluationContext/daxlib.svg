...
| fillColor | STRING | Color for the box fill | Yes |
| strokeColor | STRING | Color for lines, whiskers, and median | Yes |
| showOutliers | BOOLEAN | Whether to show outlier points beyond whiskers | No |
